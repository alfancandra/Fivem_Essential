Locales['en'] = {
  ...
  ['gave_item'] = 'Kamu Memberikan ~y~%sx~s~ ~b~%s~s~ Ke orang lain',
  ['received_item'] = 'Kamu Mendapatkan ~y~%sx~s~ ~b~%s~s~ Dari Orang lain',
  ['gave_weapon'] = 'Kamu Memberikan ~b~%s~s~ Ke orang Lain',
  ['gave_weapon_ammo'] = 'Kamu Memberikan ~o~%sx %s~s~ sejumlah ~b~%s~s~ Ke orang lain',
  ['gave_weapon_withammo'] = 'Kamu Memberikan ~b~%s~s~ Dengan ~o~%sx %s~s~ Ke orang lain',
  ['gave_weapon_hasalready'] = '~y~%s~s~ already has a ~y~%s~s~',
  ['gave_weapon_noweapon'] = '~y~%s~s~ does not have that weapon',
  ['received_weapon'] = 'Kamu Mendapatkan ~b~%s~s~ Dari Orang lain',
  ['received_weapon_ammo'] = 'Kamu Mendapatkan ~o~%sx %s~s~ untuk anda ~b~%s~s~ Dari orang lain',
  ['received_weapon_withammo'] = 'Kamu Mendapatkan ~b~%s~s~ dengan ~o~%sx %s~s~ Dari orang lain',
  ...
  ['gave_account_money'] = 'Kamu memberikan ~g~$%s~s~ (%s) Ke orang lain',
  ['received_account_money'] = 'Kamu Mendapatkan ~g~$%s~s~ (%s) Dari Seseorang',
